    ...
    def maybeSave(self):
        if self.document().isModified():
            ret = QtGui.QMessageBox.warning(
                self, "MDI", "'%s' has been modified.\nDo you want to save "
                "your changes?" % self.userFriendlyCurrentFile(),
