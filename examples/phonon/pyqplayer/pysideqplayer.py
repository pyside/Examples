...
class QPlayer(QtGui.QWidget):
    ...
    def buildGUI(self):
        ...
        self.lcdTimer.setSizePolicy(QtGui.QSizePolicy.Fixed,
                                    QtGui.QSizePolicy.Fixed)
        self.seekSlider.setSizePolicy(QtGui.QSizePolicy.Expanding,
                                      QtGui.QSizePolicy.Fixed)
        self.volumeSlider.setSizePolicy(QtGui.QSizePolicy.Expanding,
                                        QtGui.QSizePolicy.Fixed)
    ...
    def setupConnections(self):
        ...
        self.connect(self.playButton, QtCore.SIGNAL("clicked()"),
                     self.playClicked)  # self.playClicked
        self.connect(self.pauseButton, QtCore.SIGNAL("clicked()"),
                     self.pauseClicked)
        self.connect(self.stopButton, QtCore.SIGNAL("clicked()"),
                     self.stopClicked)
        self.connect(self.fileEdit, QtCore.SIGNAL(
            "textChanged(const QString&)"), self.checkFileName)
